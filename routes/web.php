...
Route::group(['prefix' => 'sisadmin/'], function () {
    ...
    Route::group(['prefix' => 'unidaddespacho'], function () {
        Route::get('/', 'UnidadDespachoController@index');
        Route::get('/create', 'UnidadDespachoController@create');
        Route::get('/edit/{und_id}', 'UnidadDespachoController@edit');
        ...
        Route::get('/editar/{und_id}', 'UnidadDespachoController@editar');
        Route::post('/storeeditar', 'UnidadDespachoController@storeeditar');
    });

    Route::group(['prefix' => 'unidadsecretaria'], function () {
        Route::get('/', 'UnidadSecretariaController@index');
        Route::get('/create', 'UnidadSecretariaController@create');
        Route::get('/edit/{und_id}', 'UnidadSecretariaController@edit');
        Route::post('/store', 'UnidadSecretariaController@store');
        Route::post('/_modificarEstado', 'UnidadSecretariaController@_modificarEstado');
        Route::post('/_eliminarimagen_unidad', 'UnidadSecretariaController@_eliminarimagen_unidad');

        Route::get('/editar/{und_id}', 'UnidadSecretariaController@editar');
    ...
    Route::group(['prefix' => 'imagenunidadgaleria'], function () {
        Route::get('/create/{und_id}/{ruta}', 'ImagenUnidadGaleriaController@create');
        Route::get('/edit/{iug_id}/{und_id}/{ruta}', 'ImagenUnidadGaleriaController@edit');
        Route::post('/store', 'ImagenUnidadGaleriaController@store');
        Route::post('/_modificarEstado', 'ImagenUnidadGaleriaController@_modificarEstado');
        Route::post('/_cambiarPublicar', 'ImagenUnidadGaleriaController@_cambiarPublicar');
        Route::get('/{und_id}/{ruta}', 'ImagenUnidadGaleriaController@index');
    });

    Route::group(['prefix' => 'biografia'], function () {
        Route::get('/', 'BiografiaController@index');
        Route::get('/create', 'BiografiaController@create');
        Route::get('/edit/{bio_id}', 'BiografiaController@edit');
        Route::post('/store', 'BiografiaController@store');
        Route::post('/_modificarEstado', 'BiografiaController@_modificarEstado');
    });
    ...
    Route::group(['prefix' => 'usuario'], function () {
        ...
        Route::get('/edit/{usr_id}', 'UsuarioController@edit');
        Route::post('/store', 'UsuarioController@store');
        Route::get('/editContrasenia/{usr_id}', 'UsuarioController@editContrasenia');
        Route::post('/storeContrasenia', 'UsuarioController@storeContrasenia');
        Route::post('/_cambiarEstado', 'UsuarioController@_cambiarEstado');

        Route::get('/roles/{usr_id}', 'UsuarioController@rolesUsuario');
        Route::post('/storeRoles', 'UsuarioController@storeRoles');
    });

    //NOTICIAS
    Route::group(['prefix' => 'noticia'], function () {
        Route::get('/{und_id}/lista', 'NoticiaController@index');
        Route::get('/create/{und_id}', 'NoticiaController@create');
        Route::get('/edit/{not_id}', 'NoticiaController@edit');
        Route::post('/store', 'NoticiaController@store');
        Route::post('/_cambiarPublicar', 'NoticiaController@_cambiarPublicar');
        Route::post('/_cambiarEstado', 'NoticiaController@_cambiarEstado');
        Route::get('/imagenes/{not_id}', 'NoticiaController@imagenes');
    ...
    Route::group(['prefix' => 'roles'], function () {
        ...
        Route::get('/create', 'RolController@create');
        Route::get('/edit/{rol_id}', 'RolController@edit');
        Route::post('/store', 'RolController@store');
        Route::post('/_modificarEstado', 'RolController@_modificarEstado');
    });
