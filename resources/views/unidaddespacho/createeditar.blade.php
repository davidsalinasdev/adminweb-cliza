...
<div class="row justify-content-center">
    <div class="col-md-12">
        ...
        @else
        <h3 align="center">Editar Datos Generales</h3>
        @endif
        @if ($unidadDespacho->und_id == 0)
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="panel-dos" role="tabpanel" aria-labelledby="dos-tab">
                    ...
                    <div class="col-md-12 row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-md-4 col-form-label text-right">Imagenes banners:</label>
                                <div class="col-md-8">
                                    ...
                                    <p class="form-text text-danger">{{ $message }}</p>
                                    @enderror
                                    <p style="font-size:12px">La imagen no puede ser mayor a 1500 x 521 pixeles y debe de ser en formato jpg o jpeg menor a 4Mb </p>
                                </div>
                            </div>
                            @if ($unidadDespacho->und_id == 0)
                            @else
