...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-azul">
        <a class="navbar-brand" href="{{ route('home') }}">
            <div class="carousel-item active">
                <img class="d-block" src="{{ asset('images/logocliza.png') }}" alt="First slide" style="width: 180px;">
            </div>
        </a>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-azul">
        ...
        <a class="navbar-brand" href="{{ route('home') }}">
            <div class="carousel-item active">
                <img class="d-block" src="{{ asset('images/logocliza.png') }}" alt="First slide" style="width: 150px;">
            </div>
        </a>
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                        ...
                        <li><a class="dropdown-item" href="{{url('sisadmin/unidaddespacho/editar/'.Auth::user()->und_id)}}">Datos generales</a></li>
                        <li><a class="dropdown-item" href="{{url('sisadmin/imagenunidadgaleria/'.Auth::user()->und_id).'/unidaddespacho'}}">Campañas</a></li>
                        ...
                        <!-- Noticias -->
                        <li><a class="dropdown-item" href="{{url('sisadmin/noticia/'.Auth::user()->und_id.'/lista')}}">Noticias</a></li>

                        <!-- Mediateka -->
                        <li class="d-none"><a class="dropdown-item @if(!verificarAcceso(13)) disabled @endif" href="{{url('sisadmin/videosonido/'.Auth::user()->und_id)}}">Mediateka</a></li>

                        <!-- Semanario -->
                        <li class="d-none"><a class="dropdown-item" href="{{ route('con-semanarios.index') }}">Semanario digital</a></li>

                        <!-- Transmisiones -->
                        <li class="d-none"><a class="dropdown-item" href="{{ route('transmisiones.index') }}">Transmisión TV en linea</a></li>

                        <!-- Gobernación TV -->
                        <li class="d-none"><a class="dropdown-item" href="{{ route('gobernaciontv.index') }}">Gobernación TV</a></li>

                        <!-- Gobernación TV -->
                        <li class="d-none"><a class="dropdown-item" href="{{ route('radiotv.index') }}">Radio online</a></li>


                        <!-- Jaku -->
                        <li class="d-none"><a class="dropdown-item" href="{{ route('gestionjakutv.index') }}">JAKU</a></li>
                        ...
                        <!-- Secretarias -->
                        <li class="d-none"><a class="dropdown-item" href="{{url('sisadmin/unidadsecretaria')}}">Secretarias</a></li>
                        <li><a class="dropdown-item" href="{{url('sisadmin/biografia')}}">Biografias</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink3">
                        ...
                        <!-- Convocatoria -->
                        <li class="d-none"><a class="dropdown-item @if(!verificarAcceso(18)) disabled @endif" href="{{url('sisadmin/convocatoria/'.Auth::user()->und_id.'/lista')}}">Convocatorias</a></li>
                        <!-- Auditoria -->
                        ...
                        <li class="d-none"><a class="dropdown-item @if(!verificarAcceso(68)) disabled @endif" href="{{url('sisadmin/rendicioncuenta/'.Auth::user()->und_id.'/lista')}}">Rendición de Cuentas</a></li>

                        <!-- Planes -->
                        <li class="d-none"><a class="dropdown-item @if(!verificarAcceso(105)) disabled @endif" href="{{url('sisadmin/plan')}}">Pilares de la Gestión</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink5">
                        <li><a class="dropdown-item" href="{{url('sisadmin/roles')}}">Roles</a></li>
                        <li><a class="dropdown-item" href="{{url('sisadmin/usuario/usuarios')}}">Usuarios</a></li>
                    </ul>
                </li>
